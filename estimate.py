...
print('*'*50)
print('transfer matrix ready...')
print('splitting string...')
print('this would take a little longer than your expectation,')
print('according to the length of your text...')
...
def fillin(column, num):
    """
    一种简单的平滑方法，方式是把每一个词的频数减少0.5，把剩下的概率平均分配给每一个词，包括原本发射概率为0的情况
    :param column: 发射矩阵的每一个列
    :param num:发射矩阵列的标号
    :return: None
    """
...
print('Done! Please run fenci.py to get your job done.')